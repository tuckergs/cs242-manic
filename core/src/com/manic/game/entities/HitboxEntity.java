 ...
 * on here. We need be able to reference projectiles, characters,
...
public class HitboxEntity extends GameEntity
{
    ...
    protected HitboxGroup hboxes;	
	
    public HitboxEntity(BodyDef bdef, World world,
			Vector2 coordinates, SpriteBatch batch,
    ...
    public void addHitbox (Vector2 coordinates, Vector2 dimensions,
			   HitboxType type, String hboxUserData,
			   float damage, int hitstun)
    {
	hboxes.add(new Hitbox(body, coordinates,
			      dimensions, type,
			      hboxUserData, damage,
			      hitstun));
    }
